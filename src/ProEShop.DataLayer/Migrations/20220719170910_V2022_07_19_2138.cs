...
{
    public partial class V2022_07_19_2138 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvinceAndCities", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRealPerson = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    SellerCode = table.Column<int>(type: "int", nullable: true),
                    ...
                    IdCartPicture = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
