...
public class IndexModel : PageBase
{
    ...
    public IndexModel(IFeatureConstantValueService featureConstantValueService, ICategoryService categoryService, ICategoryFeatureService categoryFeatureService, IUnitOfWork uow, IMapper mapper)
    {
    ...
    public async Task<IActionResult> OnPostAdd(AddFeatureConstantValueViewModel model)
    {
        ...
        var featureConstantValue = _mapper.Map<Entities.FeatureConstantValue>(model);
        await _featureConstantValueService.AddAsync(featureConstantValue);
        await _uow.SaveChangesAsync();
