...
public class LoginWithPhoneNumberModel : PageBase
{
    ...
    public LoginWithPhoneNumberModel(IApplicationUserManager userManager, IApplicationSignInManager signInManager, IUnitOfWork uow)
    {
    ...
    public async Task<IActionResult> OnGetAsync(string phoneNumber)
    {
        ...
        LoginWithPhoneNumber.SendSmsLastTimeSecond = second;
